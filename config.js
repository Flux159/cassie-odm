        ...
        options: {
            ...
            keyspace: "mykeyspace",
						...
						replication: {
							...
							strategy_options: { //Strategy options is only taken into account for NetworkTopologyStrategy - if not specified, then throws error if trying to sync. Some defaults if you use EC2 VPC's '0':3 for '0' datacenter routing of 10.<data-center>.0.0/16 (see RackInferringSnitch documentation for more info). Note that if using PropertyFileSnitch, you need to set this correctly. 
								'0': 3
								// 'us-east':3,
								// 'us-west':3
							}
