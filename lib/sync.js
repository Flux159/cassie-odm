...
exports.createTables = function (createTablesDictionary, connection, options, callback) {
    ...
    Object.keys(createTablesDictionary).forEach(function (tableName) {
        ...
        //TODO NOTE: WITH CLUSTERING ORDER BY (field ASC|DESC)
        //TODO NOTE: compression = JSON_OBJECT
        //TODO NOTE: compaction = JSON_OBJECT
        //TODO NOTE: Compact storage is not supported

        //Use schema._createOptions for options when creating a table
        //schema.createOptions should be an object containing clustering_order: {field: 1|-1}, compression: JSON, compaction: JSON

        //Data modeling notes:
        //In memory the row is sorted internally by fields
        //Ie, create tables and do a lot of writes to support your queries
        //Sort tables when creating them to do quick sorts
