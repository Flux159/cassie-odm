...
//				console.log("Creating model with doc: ");
//				console.log(doc);
...
//                        var value;
                        ...
                        Object.defineProperty(_this, virtual_field, {
                            get: function() { return _this._schema._virtuals[virtual_field].get(); },
//                            set: function(newValue) {
//                                _this._is_dirty[field] = true;
//                                value = newValue;
//                            }
...
//				for(var field in this._schema._fields) {
//					// if(field === 'save') {
...
//						var fields = saveOptions;
                    ...
                    Object.keys(this._schema.validators).forEach(function(key) {
                        ...
                        if(!passed) {
                            callback("Cassie Validation Error: " + key + "failed validation. Object was not saved to database.", null);
                        }
                    });
                    ...
                    //Run pre-save functions (pass in model - ie "this")
