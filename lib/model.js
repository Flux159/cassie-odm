...
function Model(doc, docOptions, schema, connection, options) {
...
exports.create = function(schema, connection, options) {
	return new Model(null, null, schema, connection, options);
};
