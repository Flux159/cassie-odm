...
exports.connect = function (config) {
    ...
    Cassie.keyspace = config.keyspace.toLowerCase();
    Cassie.hosts = config.hosts;
    Cassie.contactPoints = config.hosts;
    Cassie.config = config;

    var newConfig = config;
    newConfig.contactPoints = config.hosts;
    newConfig.keyspace = config.keyspace.toLowerCase();

    var connection = new cql.Client(newConfig);
...
exports.checkKeyspace = function (config, options, callback) {
    var client = new cql.Client({contactPoints: config.hosts});
